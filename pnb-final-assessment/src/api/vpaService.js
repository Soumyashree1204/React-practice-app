...
const VPA_API_URL = import.meta.env.VITE_FETCH_VPA_URL || 'https://auth-dev-stage.iserveu.online/pnb/fetch/fetchById';
...
const CURRENT_LANGUAGE_URL = import.meta.env.VITE_CURRENT_LANGUAGE_URL || 'https://auth-dev-stage.iserveu.online/pnb/isu_soundbox/user_api/current_language';
...
const LANGUAGE_LIST_URL = import.meta.env.VITE_FETCH_LANGUAGE_LIST_URL || 'https://auth-dev-stage.iserveu.online/pnb/isu_soundbox/lang/fetch_language';
...
const UPDATE_LANGUAGE_URL = import.meta.env.VITE_UPDATE_LANGUAGE_URL || 'https://api-dev-stage.iserveu.online/pnb/bank/lang/update_language';
...
const QR_GENERATE_URL = import.meta.env.VITE_QR_GENERATE_URL || 'https://auth-dev-stage.iserveu.online/pnb/merchant/qr_convert_to_base64';
...
const TRANSACTION_REPORTS_URL = import.meta.env.VITE_TRANSACTION_REPORTS_URL || 'https://api-dev-stage.iserveu.online/pnb/sb/reports/querysubmit_user';
